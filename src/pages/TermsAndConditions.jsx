    ...
    return (
        <div id="terms-and-conditions">
            ...
            <main>
                ...
                <p>Welcome to HelpMeChooseOne.com. We search the Internet to find goods and services that that we think would save our visitors money. We do not sell any products or services; everything featured on our site is sold by third-parties.</p>
                <p>We participate in affiliate programmes, meaning that we may earn a commission if a visitor purchases a product or service featured on our site.</p>
                <p>Before making a purchase from any third-party vendor, please ensure you read their terms and conditions and obtain the most accurate and up-to-date product details before making the transaction. We will not be held responsible for any loss or damage caused by purchases made on third-party websites.</p>
                <p>Please continue reading for full details of our terms and conditions.</p>
                ...
                <ul>
                    ...
                    <li><b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to HelpMeChooseOne.com.</li>
                    ...
                    <li><b>Website</b> refers to HelpMeChooseOne.com, accessible from https://helpmechooseone.com/</li>
                ...
                <p>If you have any questions about these Terms and Conditions, You can contact us by sending an email to hi@helpmechooseone.com.</p>
            </main>
        </div>
    )
}